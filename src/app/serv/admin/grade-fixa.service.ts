...
export class GradeFixaService {
  private apiUrl = 'https://api.piatividade.duckdns.org/reservation/';
  private teachersUrl = 'https://api.piatividade.duckdns.org/teacher/';
  private subjectsUrl = 'https://api.piatividade.duckdns.org/subject/';
  private timesUrl = 'https://api.piatividade.duckdns.org/time/';
  private roomsUrl = 'https://api.piatividade.duckdns.org/rooms/';
  private coursesUrl = 'https://api.piatividade.duckdns.org/course/';
