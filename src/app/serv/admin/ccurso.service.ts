...
export class CcursoService {
  private apiUrl = 'https://api.piatividade.duckdns.org/course/';  // URL principal para cursos
  private disciplinesUrl = 'https://api.piatividade.duckdns.org/subject/';  // URL para buscar as disciplinas
