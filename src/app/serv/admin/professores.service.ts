...
export class ProfessoresService {
  private apiUrl = 'https://api.piatividade.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://api.piatividade.duckdns.org/courses'; // Caso precise acessar cursos também
